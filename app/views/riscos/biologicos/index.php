...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    ...
    <div>
        ...
        <p class="text-muted mb-0">
            Gerenciamento de riscos biológicos cadastrados no sistema
        </p>
    </div>

    <a href="<?= BASE_URL ?>/riscos/novo/biologico"
                ...
                <?php else: ?>
                    ...
                    <tr>
                        <td colspan="4" class="text-center py-5 text-muted">
                            <i class="fas fa-disease fa-3x mb-3 opacity-50"></i>
                            <div>Nenhum risco biológico cadastrado</div>
                        </td>
                    </tr>
