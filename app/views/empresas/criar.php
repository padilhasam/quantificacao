    ...
    <div class="container-fluid px-2 px-lg-4 mb-4">
        ...
        <header class="mb-4 px-4 py-3 bg-white border rounded-3 shadow-sm d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <small class="text-muted d-block mt-1">Insira os dados cadastrais, localização e contatos da nova empresa cliente/parceira</small>
            </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="razao_social" id="razao_social" maxlength="200" required>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="nome_fantasia" id="nome_fantasia" maxlength="200">
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="inscricao_estadual" id="inscricao_estadual" maxlength="50">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="telefone" id="telefone" placeholder="(00) 0000-0000">
                            </div>

                            <div class="col-12 col-md-8">
                                <label for="email" class="form-label fw-semibold text-secondary small">E-mail Institucional</label>
                                <input type="email" class="form-control rounded-3 border-dark-subtle" name="email" id="email" placeholder="comercial@empresa.com" maxlength="150">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="responsavel" id="responsavel" maxlength="150">
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="contato_responsavel" class="form-label fw-semibold text-secondary small">Contato do Responsável (Telefone/WhatsApp)</label>
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="contato_responsavel" id="contato_responsavel" placeholder="(00) 00000-0000">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-12 col-md-3">
                                ...
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="cep" id="cep" placeholder="00000-000">
                            </div>

                            <div class="col-12 col-md-5">
                                <label for="endereco" class="form-label fw-semibold text-secondary small">Logradouro (Rua, Número, Bairro)</label>
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="endereco" id="endereco" placeholder="Ex: Rua das Flores, 123 - Centro">
                            </div>
                            
                            <div class="col-12 col-md-4">
                                <label for="cidade_uf" class="form-label fw-semibold text-secondary small">Cidade / UF</label>
                                <input type="text" class="form-control rounded-3 border-dark-subtle" name="cidade_uf" id="cidade_uf" placeholder="Ex: Curitiba / PR">
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Máscaras de Telefone genéricas (aceita fixo e celular)
