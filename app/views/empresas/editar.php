            ...
            <div>
                <h3 class="m-0 fw-bold text-dark d-flex align-items-center gap-3" style="font-size: 1.5rem;">
                    <span class="icon-container d-flex align-items-center justify-content-center"
                          style="width: 38px; height: 38px; background: linear-gradient(135deg, #ffc107, #ff9800); border-radius: 8px;">
                        <i class="fas fa-building text-white" style="font-size: 1.10rem;"></i>
                    </span>
                    Editar Empresa
                </h3>
                <small class="text-muted d-block mt-1">
                    Atualize os dados cadastrais, localização, contatos e informações técnicas da empresa.
                </small>
            </div>
                ...
                <form action="<?= BASE_URL ?>/empresas/atualizar/<?= $empresa['id'] ?>" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle text-uppercase" name="codigo" id="codigo" value="<?= htmlspecialchars($empresa['codigo'] ?? '') ?>" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle text-uppercase" name="codigo_externo" id="codigo_externo" value="<?= htmlspecialchars($empresa['codigo_externo'] ?? '') ?>" maxlength="80">
                                </div>
                            </div><br>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="cnpj" id="cnpj" value="<?= htmlspecialchars($empresa['cnpj'] ?? '') ?>" placeholder="00.000.000/0000-00">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="inscricao_estadual" id="inscricao_estadual" value="<?= htmlspecialchars($empresa['inscricao_estadual'] ?? '') ?>" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="razao_social" id="razao_social" value="<?= htmlspecialchars($empresa['razao_social'] ?? '') ?>" maxlength="200" required>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="nome_fantasia" id="nome_fantasia" value="<?= htmlspecialchars($empresa['nome_fantasia'] ?? '') ?>" maxlength="200">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-dark-subtle" name="cnae" id="cnae" value="<?= htmlspecialchars($empresa['cnae'] ?? '') ?>" placeholder="00.00-0/00" maxlength="30">
                                        </div>
                                    </div>

                                    <div class="col-md-8">
                                        <div class="form-control bg-light border-dark-subtle d-flex align-items-center" style="min-height:46px;">
                                            <input type="hidden" name="descricao_cnae" id="descricao_cnae" value="<?= htmlspecialchars($empresa['descricao_cnae'] ?? '') ?>">

                                            <small class="<?= !empty($empresa['descricao_cnae']) ? 'text-dark fw-semibold' : 'text-muted' ?> d-block" id="descricaoCnaeTexto">
                                                <?= !empty($empresa['descricao_cnae'])
                                                    ? htmlspecialchars($empresa['descricao_cnae'])
                                                    : 'A descrição do CNAE será preenchida automaticamente pela consulta do CNPJ.' ?>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-6 col-lg-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select border-dark-subtle" name="grau_risco" id="grau_risco">
                                        <option value="">Selecione...</option>
                                        <?php for ($i = 1; $i <= 4; $i++): ?>
                                            <option value="<?= $i ?>" <?= (($empresa['grau_risco'] ?? '') == $i) ? 'selected' : '' ?>>
                                                Grau <?= $i ?>
                                            </option>
                                        <?php endfor; ?>
                                    </select>
                            ...
                            <div class="col-6 col-lg-2">
                                <label for="quantidade_funcionarios" class="form-label fw-semibold text-secondary small">Funcionários</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-dark-subtle text-muted">
                                        <i class="fas fa-users"></i>
                                    </span>
                                    <input type="number" class="form-control border-dark-subtle" name="quantidade_funcionarios" id="quantidade_funcionarios" value="<?= htmlspecialchars($empresa['quantidade_funcionarios'] ?? '') ?>" min="0" placeholder="0">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="responsavel" id="responsavel" value="<?= htmlspecialchars($empresa['responsavel'] ?? '') ?>" maxlength="150">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="cargo_responsavel" id="cargo_responsavel" value="<?= htmlspecialchars($empresa['cargo_responsavel'] ?? '') ?>" maxlength="150">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="telefone" id="telefone" value="<?= htmlspecialchars($empresa['telefone'] ?? '') ?>" placeholder="(00) 0000-0000">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="contato_responsavel" id="contato_responsavel" value="<?= htmlspecialchars($empresa['contato_responsavel'] ?? '') ?>" placeholder="(00) 00000-0000">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control rounded-end-3 border-dark-subtle" name="email" id="email" value="<?= htmlspecialchars($empresa['email'] ?? '') ?>" maxlength="150">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="cep" id="cep" value="<?= htmlspecialchars($empresa['cep'] ?? '') ?>" placeholder="00000-000">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="logradouro" id="logradouro" value="<?= htmlspecialchars($logradouro) ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="numero" id="numero" value="<?= htmlspecialchars($numero) ?>" maxlength="20">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="complemento" id="complemento" value="<?= htmlspecialchars($complemento) ?>" maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="bairro" id="bairro" value="<?= htmlspecialchars($bairro) ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="cidade" id="cidade" value="<?= htmlspecialchars($cidade) ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle text-uppercase" name="estado" id="estado" value="<?= htmlspecialchars($estado) ?>" maxlength="2">
                                </div>
                            </div>

                            <input type="hidden" name="endereco" id="endereco" value="<?= htmlspecialchars($empresa['endereco'] ?? '') ?>">
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="tecnico_responsavel" id="tecnico_responsavel" value="<?= htmlspecialchars($empresa['tecnico_responsavel'] ?? '') ?>" maxlength="150">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle" name="supervisor_responsavel" id="supervisor_responsavel" value="<?= htmlspecialchars($empresa['supervisor_responsavel'] ?? '') ?>" maxlength="150">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select rounded-end-3 border-dark-subtle" name="periodicidade_visitas" id="periodicidade_visitas">
                                        <option value="">Selecione...</option>
                                        <?php foreach (['Mensal','Bimestral','Trimestral','Semestral','Anual','Sob demanda'] as $opcao): ?>
                                            <option value="<?= $opcao ?>" <?= (($empresa['periodicidade_visitas'] ?? '') === $opcao) ? 'selected' : '' ?>>
                                                <?= $opcao ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control rounded-end-3 border-dark-subtle" name="observacoes" id="observacoes" rows="4"><?= htmlspecialchars($empresa['observacoes'] ?? '') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="form-check form-switch d-flex align-items-center gap-3 ps-0">
                            <input class="form-check-input switch-lg m-0 border-dark-subtle" type="checkbox" id="ativo" name="ativo" value="1" <?= ((int)($empresa['ativo'] ?? 0) === 1) ? 'checked' : '' ?> style="cursor: pointer;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function buscarCep(cepValor) {
        const cepLimpo = String(cepValor || '').replace(/\D/g, '');
            ...
            try {
                ...
                if (data.cnae_fiscal_descricao) {
                    ...
                    if (descricaoCnaeTexto) {
                        ...
                        `;
                        descricaoCnaeTexto.classList.remove('text-muted');
                        descricaoCnaeTexto.classList.add('text-dark', 'fw-semibold');
                    }
                }
