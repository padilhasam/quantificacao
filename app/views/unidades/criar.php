...
<main class="content flex-grow-1 pt-3 px-4 pb-4 bg-light-subtle">
    <div class="container-fluid px-2 px-lg-4 mb-4">
        ...
        $codigoInterno = 'UND' . strtoupper(uniqid());
        $codigoExterno = 'EXT-UND-' . date('YmdHis');
        ?>
        ...
        <header class="page-header-unidades mb-4 px-4 py-3 bg-white border rounded-3 shadow-sm d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <small class="text-muted d-block mt-1">
                    Cadastre a unidade operacional com dados próprios e vínculo com a empresa principal.
                </small>
            </div>
                ...
                <form action="<?= BASE_URL ?>/unidades/salvar" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-balance-scale"></i> Identificação da Unidade
                        </h6>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle text-uppercase bg-light"
                                           name="codigo" id="codigo" value="<?= htmlspecialchars($codigoInterno) ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle text-uppercase bg-light"
                                           name="codigo_externo" id="codigo_externo" value="<?= htmlspecialchars($codigoExterno) ?>" readonly>
                                </div>
                            </div><br>

                            <div class="col-12 col-md-6">
                                <label for="cnpj" class="form-label fw-semibold text-secondary small">CNPJ da Unidade</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-dark-subtle rounded-start-3 text-muted">
                                        <i class="fas fa-id-card"></i>
                                    </span>
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="inscricao_estadual" id="inscricao_estadual" maxlength="50">
                                </div>
                            </div>

                            <div class="col-12">
                                <label for="empresa_id" class="form-label fw-semibold text-secondary small">Empresa Vinculada *</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-dark-subtle rounded-start-3 text-muted">
                                        <i class="fas fa-building"></i>
                                    </span>

                                    <select class="form-select rounded-end-3 border-dark-subtle" name="empresa_id" id="empresa_id" required>
                                        <option value="" disabled selected>Selecione a empresa vinculada...</option>
                                    ...
                                    <div class="invalid-feedback">
                                        Selecione a empresa vinculada a esta unidade.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="nome" id="nome" placeholder="Ex: Matriz, Filial Curitiba, Planta Industrial" maxlength="150" required>
                                    <div class="invalid-feedback">O nome da unidade é obrigatório.</div>
                                </div>
                            </div>

                            <div class="col-12">
                                <label for="nome_fantasia" class="form-label fw-semibold text-secondary small">Nome Fantasia da Unidade</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-dark-subtle rounded-start-3 text-muted">
                                        <i class="fas fa-store"></i>
                                    </span>
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="nome_fantasia" id="nome_fantasia" maxlength="200">
                                </div>
                            </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-chart-pie"></i> Características da Unidade
                        </h6>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-dark-subtle"
                                                   name="cnae" id="cnae" placeholder="00.00-0/00" maxlength="30">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-control bg-light border-dark-subtle d-flex align-items-center" style="min-height:46px;">
                                            ...
                                            <small class="text-muted d-block" id="descricaoCnaeTexto">
                            ...
                            <div class="col-6 col-lg-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control border-dark-subtle"
                                           name="quantidade_funcionarios" id="quantidade_funcionarios" min="0" placeholder="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-envelope-open-text"></i> Contatos da Unidade
                        </h6>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="responsavel" id="responsavel" maxlength="150">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="cargo_responsavel" id="cargo_responsavel" maxlength="150">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="telefone" id="telefone" placeholder="(00) 0000-0000">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="contato_responsavel" id="contato_responsavel" placeholder="(00) 00000-0000">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control rounded-end-3 border-dark-subtle"
                                           name="email" id="email" placeholder="unidade@empresa.com" maxlength="150">
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-map-marked-alt"></i> Endereço da Unidade
                        </h6>

                        <div class="row g-3 endereco-row">
                            <div class="col-12 col-md-3">
                            ...
                            <div class="col-12 col-md-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="logradouro" id="logradouro" placeholder="Rua, Avenida, Rodovia">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="numero" id="numero" maxlength="20">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-1">
                                ...
                                <input type="text" class="form-control border-dark-subtle text-uppercase text-center"
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-user-gear"></i> Gestão da Unidade
                        </h6>

                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                <label for="tecnico_responsavel" class="form-label fw-semibold text-secondary small">Responsável Técnico SST</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-dark-subtle rounded-start-3 text-muted">
                                        <i class="fas fa-helmet-safety"></i>
                                    </span>
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="tecnico_responsavel" id="tecnico_responsavel" maxlength="150">
                                </div>
                            </div>

                            <div class="col-12 col-md-4">
                                <label for="supervisor_responsavel" class="form-label fw-semibold text-secondary small">Gestor / Supervisor Interno</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-dark-subtle rounded-start-3 text-muted">
                                        <i class="fas fa-user-check"></i>
                                    </span>
                                    <input type="text" class="form-control rounded-end-3 border-dark-subtle"
                                           name="supervisor_responsavel" id="supervisor_responsavel" maxlength="150">
                                </div>
                            </div>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control rounded-end-3 border-dark-subtle"
                                      name="observacoes" id="observacoes" rows="4"
                                      placeholder="Informações adicionais sobre a unidade, operação, contrato ou particularidades do local."></textarea>
                        </div>
                    </div>

                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-toggle-on"></i> Situação da Unidade
                        </h6>
                        ...
                        <div class="form-check form-switch d-flex align-items-center gap-3 ps-0">
                            <input class="form-check-input switch-lg m-0 border-dark-subtle"
                                   type="checkbox" id="ativo" name="ativo" value="1" checked style="cursor: pointer;">
                            ...
                            <div>
                                ...
                                <div class="status-text mt-0.5">
                                    <span class="badge bg-success-subtle text-success px-2 py-1 rounded-pill">Unidade Ativa</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateStatus() {
        ...
        statusText.innerHTML = switchInput.checked
            ? `<span class="badge bg-success-subtle text-success px-2 py-1 rounded-pill">Unidade Ativa</span>`
            : `<span class="badge bg-danger-subtle text-danger px-2 py-1 rounded-pill">Unidade Inativa</span>`;
    }
    ...
    if (cnpjInput) {
        ...
        cnpjInput.addEventListener('blur', async function () {
            ...
            try {
                ...
                preencherCampo('nome', data.nome_fantasia || data.razao_social || data.nome);
                ...
                if (data.qsa && data.qsa.length) {
                    preencherCampo('responsavel', data.qsa[0].nome_socio || '');
                    preencherCampo('cargo_responsavel', data.qsa[0].qualificacao_socio || '');
                }
