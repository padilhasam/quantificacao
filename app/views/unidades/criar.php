        ...
        <header class="mb-4 px-4 py-3 bg-white border rounded-3 shadow-sm d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <small class="text-muted d-block mt-1">
                    Insira os dados cadastrais, localização e vínculo institucional da nova unidade física
                </small>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body p-4">
                ...
                <form action="<?= BASE_URL ?>/unidades/salvar" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <label for="empresa_id" class="form-label fw-semibold text-secondary small">
                                    Empresa Responsável *
                                </label>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="nome"
                                           id="nome"
                                           placeholder="Ex: Planta Industrial Principal"
                                           maxlength="150"
                                           required>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="cnpj" class="form-label fw-semibold text-secondary small">
                                    CNPJ da Unidade
                                </label>
                    ...
                    <div class="border rounded-3 p-3 mb-4 bg-light-subtle">
                        <h6 class="text-primary fw-bold mb-3 d-flex align-items-center gap-2">
                            <i class="fas fa-map-marker-alt"></i> Endereço e Status da Unidade
                        </h6>

                        <div class="row g-3 align-items-center">
                            <div class="col-12 col-md-5">
                                <label for="endereco" class="form-label fw-semibold text-secondary small">
                                    Logradouro
                                </label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="endereco"
                                           id="endereco"
                                           placeholder="Ex: Av. das Nações, 2500 - Distrito Industrial">
                                </div>
                            </div>
                            
                            <div class="col-12 col-md-4">
                                <label for="cidade_uf" class="form-label fw-semibold text-secondary small">
                                    Cidade / UF
                                </label>
